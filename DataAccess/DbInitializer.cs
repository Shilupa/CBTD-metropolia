...
namespace DataAccess
{
    public class DbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            new Category { CategoryName = "Non-Alcoholic Beverages", DisplayOrder = 1 },
            new Category { CategoryName = "Wine", DisplayOrder = 2 },
            new Category { CategoryName = "Snacks", DisplayOrder = 3 }
            };
